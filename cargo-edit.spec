...
Version  : 1
Release  : 3
URL      : file:///aot/build/clearlinux/packages/cargo-edit/cargo-edit-1.tar.gz
Source0  : file:///aot/build/clearlinux/packages/cargo-edit/cargo-edit-1.tar.gz
Summary  : No detailed summary available
Group    : Development/Tools
License  : GPL-2.0
Requires: cargo-edit-bin = %{version}-%{release}
...
%package bin
Summary: bin components for the cargo-edit package.
Group: Binaries

%description bin
bin components for the cargo-edit package.


%prep
%setup -q -n cargo-edit
cd %{_builddir}/cargo-edit
